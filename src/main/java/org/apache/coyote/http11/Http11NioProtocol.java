...
public class Http11NioProtocol implements ProtocolHandler, MBeanRegistration {
    ...
    static class Http11ConnectionHandler implements Handler {
        ...
        protected ThreadLocal<Http11NioProcessor> localProcessor = new ThreadLocal<Http11NioProcessor>();
        ...
        protected java.util.Stack<Http11NioProcessor> recycledProcessors = new java.util.Stack<Http11NioProcessor>();
                ...
                synchronized (this) {
                    try {
                        ...
                        ObjectName rpName = new ObjectName(
                                proto.getDomain() + ":type=RequestProcessor,worker=" + proto.getName() + ",name=HttpRequest" + count++);
    ...
    protected static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(Http11NioProtocol.class);
