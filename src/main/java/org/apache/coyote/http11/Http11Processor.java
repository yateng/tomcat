...
public class Http11Processor implements ActionHook {
     ...
     * 
     * @param input
     *            stream from which the HTTP requests will be read
     * @param output
    ...
    protected void prepareResponse() {
        ...
        if (System.getSecurityManager() != null) {
            date = (String) AccessController.doPrivileged(new PrivilegedAction<String>() {
    ...
    protected boolean statusDropsConnection(int status) {
        return status == 400 /* SC_BAD_REQUEST */|| status == 408 /* SC_REQUEST_TIMEOUT */|| status == 411 /* SC_LENGTH_REQUIRED */|| status == 413 /* SC_REQUEST_ENTITY_TOO_LARGE */
                || status == 414 /* SC_REQUEST_URI_TOO_LARGE */|| status == 500 /* SC_INTERNAL_SERVER_ERROR */|| status == 503 /* SC_SERVICE_UNAVAILABLE */
