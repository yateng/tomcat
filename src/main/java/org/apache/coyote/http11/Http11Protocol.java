 ...
 *
 */
//@deprecated   add by chenlian
public class Http11Protocol implements ProtocolHandler, MBeanRegistration {

    protected static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(Http11Protocol.class);
    ...
    protected static class Http11ConnectionHandler implements Handler {
        ...
        public boolean process(Socket socket) {
            ...
            try {
                ...
                if (processor == null) {
                    processor = new Http11Processor(protocol.maxHttpHeaderSize, protocol.endpoint);
                    ...
                    if (protocol.getDomain() != null) {
                        synchronized (this) {
                            try {
                                ...
                                ObjectName rpName = new ObjectName(protocol.getDomain() + ":type=RequestProcessor,worker=" + protocol.getName()
                ...
                if (protocol.secure && (protocol.sslImplementation != null)) {
                    processor.setSSLSupport(protocol.sslImplementation.getSSLSupport(socket));
                } else {
