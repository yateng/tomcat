 ...
 * 
 * <p>
 * <strong>IMPLEMENTATION NOTE</strong> - This implementation is heavily based on the SAXParserFactory and DocumentBuilderFactory implementations (corresponding
 * to the JAXP pluggability APIs) found in Apache Xerces.
 * </p>
 * 
 * 
...
public/* abstract */class LogFactory {
    ...
    /**
     * <p>
     * Setting this system property value allows the <code>Hashtable</code> used to store classloaders to be substituted by an alternative implementation.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * <strong>Usage:</strong> Set this property when Java is invoked and <code>LogFactory</code> will attempt to load a new instance of the given
     * implementation class. For example, running the following ant scriplet: <code><pre>
     ...
     *  &lt;/java&gt;
     * </pre></code> will mean that <code>LogFactory</code> will load an instance of <code>org.apache.commons.logging.AltHashtable</code>.
     * </p>
     * <p>
     * A typical use case is to allow a custom Hashtable implementation using weak references to be substituted. This will allow classloaders to be garbage
     ...
     * 
     * <p>
     * <strong>NOTE</strong> - Depending upon the implementation of the <code>LogFactory</code> you are using, the <code>Log</code> instance you are returned
     * may or may not be local to the current application, and may or may not be returned again on a subsequent call with the same name argument.
     * </p>
     * 
     * @param name
    ...
    /**
     * Release any internal references to previously created {@link Log} instances returned by this factory. This is useful in environments
     ...
     * this with a <code>null</code> value is equivalent to calling <code>removeAttribute(name)</code>.
     * 
     * @param name
    ...
    /**
     * <p>
     * Construct (if necessary) and return a <code>LogFactory</code> instance, using the following ordered lookup procedure to determine the name of the
     * implementation class to be loaded.
     * </p>
     * <ul>
     * <li>The <code>org.apache.commons.logging.LogFactory</code> system property.</li>
     * <li>The JDK 1.3 Service Discovery mechanism</li>
     * <li>Use the properties file <code>commons-logging.properties</code> file, if found in the class path of this class. The configuration file is in standard
     * <code>java.util.Properties</code> format and contains the fully qualified name of the implementation class with the key being the system property defined
     * above.</li>
     * <li>Fall back to a default implementation class (<code>org.apache.commons.logging.impl.LogFactoryImpl</code>).</li>
     * </ul>
     * 
     * <p>
     * <em>NOTE</em> - If the properties file method of identifying the <code>LogFactory</code> implementation class is utilized, all of the properties defined
     * in this file will be set as configuration attributes on the corresponding <code>LogFactory</code> instance.
     * </p>
     * 
     * @exception LogConfigurationException
     ...
     * its class.
     * <p>
     * The returned string is of form "classname@hashcode", ie is the same as the return value of the Object.toString() method, but works even when the
