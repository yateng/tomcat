...
public class Digester extends DefaultHandler {
     ...
     * used to load Digester itself, is used, based on the value of the <code>useContextClassLoader</code> variable.
     */
    ...
    /**
     * The <code>Rules</code> implementation containing our collection of <code>Rule</code> instances and associated matching policy. If not
     ...
     * <li>The thread context class loader, if it exists and the <code>useContextClassLoader</code> property is set to true</li>
     ...
     * effective, this method must be called <strong>before</strong> the <code>getParser()</code> method is called for the first time, either
    ...
    /**
     * Set the current value of the specified property for the underlying <code>XMLReader</code> implementation.
     * See <a href="http://www.saxproject.org/apidoc/xml/sax/package-summary.html#package-description"
     * http://www.saxproject.org/apidoc/xml/sax/package-summary.html#package-description</a>
     * for information about the standard SAX2 properties.
     * 
     ...
     *            a class that implement the <code>EntityResolver</code> interface.
     */
    ...
    public void fatalError(SAXParseException exception) throws SAXException {
        ...
        log.error("Parse Fatal Error at line " + exception.getLineNumber() + " column " + exception.getColumnNumber() + ": " + exception.getMessage(),
                exception);
        if (errorHandler != null) {
    ...
    public void warning(SAXParseException exception) throws SAXException {
        if (errorHandler != null) {
            log.warn("Parse Warning Error at line " + exception.getLineNumber() + " column " + exception.getColumnNumber() + ": " + exception.getMessage(),
                    exception);
    ...
    /**
     * <p>
     * Register the specified DTD URL for the specified public identifier. This must be called before the first call to <code>parse()</code>.
     * </p>
     * <p>
     * <code>Digester</code> contains an internal <code>EntityResolver</code> implementation. This maps <code>PUBLICID</code>'s to URLs (from which the resource
     * will be loaded). A common use case for this method is to register local URLs (possibly computed at runtime by a classloader) for DTDs. This allows the
     * performance advantage of using a local version without having to ensure every <code>SYSTEM</code> URI on every processed xml document is local. This
     * implementation provides only basic functionality. If more sophisticated features are required, using {@link #setEntityResolver} to set a custom resolver
     * is recommended.
     * </p>
     * <p>
     * <strong>Note:</strong> This method will have no effect when a custom <code>EntityResolver</code> has been set. (Setting a custom
    ...
    /**
     * <p>
     * Register a new Rule matching the specified pattern. This method sets the <code>Digester</code> property on the rule.
     * </p>
     * 
     * @param pattern
     ...
     *            Java wrapper class instead, such as <code>java.lang.Boolean</code> for a <code>boolean</code> parameter)
     * @see CallMethodRule
     */
     ...
     *            The zero-relative parameter number
     * @param stackIndex
     *            set the call parameter to the stackIndex'th object down the stack,
    ...
    /**
     * Add a "call parameter" rule that sets a parameter from the current <code>Digester</code> matching path.
     ...
     * <p>
     * Note that when attempting to locate a matching method to invoke, the true type of the paramObj is used, so that despite the paramObj being passed in here
     * as type Object, the target method can declare its parameters as being the true type of the object (or some ancestor type, according to the usual
     * type-conversion rules).
     * 
     * @param paramIndex
     *            The zero-relative parameter number
     * @param paramObj
     *            Any arbitrary object to be passed to the target
     *            method.
     * @see CallMethodRule
     * 
     * @since 1.6
     ...
     *            when <code>true</code> any exceptions thrown during
     ...
     * <p>
     * Calling this method <i>might</i> allow another document of the same type to be correctly parsed. However this method was not intended for this purpose.
     * In general, a separate Digester object should be created for each document to be parsed.
     */
    public void clear() {
     ...
     * 
     * @param stackName
     *            the name of the stack whose emptiness
     *            should be evaluated
    ...
    /**
     * <p>
     * Provide a hook for lazy configuration of this <code>Digester</code> instance. The default implementation does nothing, but subclasses can override as
     * needed.
     * </p>
     * 
     * <p>
     * <strong>Note</strong> This method may be called more than once. Once only initialization code should be placed in {@link #initialize} or the code should
     * take responsibility by checking and setting the {@link #configured} flag.
     * </p>
     */
    ...
    /**
     * <p>
     * Provides a hook for lazy initialization of this <code>Digester</code> instance. The default implementation does nothing, but subclasses can override as
     * needed. Digester (by default) only calls this method once.
     * </p>
     * 
     * <p>
     * <strong>Note</strong> This method will be called by {@link #configure} only when the {@link #configured} flag is false. Subclasses that override
     * <code>configure</code> or who set <code>configured</code> may find that this method may be called more than once.
     * </p>
     * 
     * @since 1.6
     */
     ...
     * 
     * @deprecated Call <code>match()</code> on the <code>Rules</code> implementation returned by <code>getRules()</code>
     */
    ...
    /**
     * <p>
     * Return the top object on the parameters stack without removing it. If there are no objects on the stack, return <code>null</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Return the n'th object down the parameters stack, where 0 is the top element and [getCount()-1] is the bottom element. If the specified index is out of
    ...
    /**
     * <p>
     * Pop the top object off of the parameters stack, and return it. If there are no objects on the stack, return <code>null</code>.
     * </p>
     * 
     * <p>
     * The parameters stack is used to store <code>CallMethodRule</code> parameters. See {@link #params}.
