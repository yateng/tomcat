 ...
 * 
 * <P>
 * Like socket factories, Server Socket factory instances have two categories of methods. First are methods used to create sockets. Second are methods which set
 * properties used in the production of sockets, such as networking options. There is also an environment specific default server socket factory; frameworks
 * will often use their own customized factory.
 * 
 * <P>
 * <hr>
