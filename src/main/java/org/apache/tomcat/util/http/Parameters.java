...
public final class Parameters extends MultiMap {
    ...
    private static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(Parameters.class);
    ...
    public void processParameters(byte bytes[], int start, int len, String enc) {
        ...
        do {
            ...
            if ((nameEnd2 != -1) && (nameEnd == -1 || nameEnd > nameEnd2)) {
                ...
                valEnd = nameEnd;
                if (debug > 0)
                    log("no equal " + nameStart + " " + nameEnd + " " + new String(bytes, nameStart, nameEnd - nameStart));
            }
            if (nameEnd == -1)
                nameEnd = end;
    ...
    public void processParameters(char chars[], int start, int len) {
        ...
        do {
            ...
            if ((nameEnd2 != -1) && (nameEnd == -1 || nameEnd > nameEnd2)) {
                ...
                valEnd = nameEnd;
                if (debug > 0)
                    log("no equal " + nameStart + " " + nameEnd + " " + new String(chars, nameStart, nameEnd - nameStart));
            }
            if (nameEnd == -1)
                nameEnd = end;
    ...
    public void processParameters(MessageBytes data, String encoding) {
        ...
        if (data.getType() == MessageBytes.T_BYTES) {
            ...
            processParameters(cc.getChars(), cc.getOffset(), cc.getLength());
        }
    }
    ...
    public void processParameters(String str) {
        ...
        do {
            ...
            if (debug > 0)
                log("XXX " + nameStart + " " + nameEnd + " " + valStart + " " + valEnd);
