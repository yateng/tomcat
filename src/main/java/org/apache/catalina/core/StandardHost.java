...
public class StandardHost extends ContainerBase implements Host {
    ...
    private static final long serialVersionUID = 1380599397965776429L;

    private static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(StandardHost.class);
        ...
        if ((errorReportValveClass != null) && (!errorReportValveClass.equals(""))) {
            try {
                ...
                if (errorReportValveObjectName != null) {
                    ObjectName[] names = ((StandardPipeline) pipeline).getValveObjectNames();
                    for (int i = 0; !found && i < names.length; i++)
                        if (errorReportValveObjectName.equals(names[i]))
                            found = true;
                }
                if (!found) { // org.apache.catalina.valves.ErrorReportValve
                ...
                log.error(sm.getString("standardHost.invalidErrorReportValveClass", errorReportValveClass));
            }
        }
    ...
    public void init() {
        ...
        if (getParent() == null) {
            try {
                ...
                if (mserver.isRegistered(serviceName)) {
                    ...
                    mserver.invoke(serviceName, "addChild", new Object[] { this }, new String[] { "org.apache.catalina.Container" });
                }
            } catch (Exception ex) {
        ...
        if (oname == null) {
            ...
            try {
                ...
                oname = new ObjectName(domain + ":type=Host,host=" + this.getName());
                controller = oname;
