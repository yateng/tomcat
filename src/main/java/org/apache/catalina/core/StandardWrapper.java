...
public class StandardWrapper extends ContainerBase implements ServletConfig, Wrapper, NotificationEmitter {
    ...
    protected static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(StandardWrapper.class);
    ...
    /**
     * Set the name of this servlet. This is an alias for the normal <code>Container.setName()</code> method, and complements the <code>getServletName()</code>
     * method required by the <code>ServletConfig</code> interface.
     * 
     * @param name
     ...
     * instance may be returned immediately. If the servlet class implements <code>SingleThreadModel</code>, the Wrapper implementation must ensure
     ...
     * <p>
     * <b>IMPLEMENTATION NOTE</b>: Servlets whose classnames begin with <code>org.apache.catalina.</code> (so-called "container" servlets) are loaded by the
     * same classloader that loaded this class, rather than the classloader for the current web application. This gives such classes access to Catalina
        ...
        try {
            ...
            try {
                if (SecurityUtil.isPackageProtectionEnabled()) {
                    ...
                    try {
                        classClass = (Class<?>) AccessController.doPrivileged(new PrivilegedExceptionAction<Object>() {
     ...
     * 
     * @param unavailable
     *            The exception that occurred, or <code>null</code> to mark this servlet as permanently unavailable
     */
    ...
    /**
     * Unload all initialized instances of this servlet, after calling the <code>destroy()</code> method for each instance. This can be used,
    ...
    protected void registerJMX(StandardContext ctx) {
        ...
        String onameStr = domain + ":j2eeType=Servlet,name=" + getName() + ",WebModule=" + webMod + ",J2EEApplication=" + ctx.getJ2EEApplication()
        ...
        if (isJspServlet) {
            ...
            onameStr = domain + ":type=JspMonitor,name=" + getName() + ",WebModule=" + webMod + ",J2EEApplication=" + ctx.getJ2EEApplication() + ",J2EEServer="
                    + ctx.getJ2EEServer();
            try {
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        ...
        if (notificationInfo == null) {
            notificationInfo = new MBeanNotificationInfo[] {
                    new MBeanNotificationInfo(new String[] { "j2ee.object.created" }, Notification.class.getName(), "servlet is created"),
                    new MBeanNotificationInfo(new String[] { "j2ee.state.starting" }, Notification.class.getName(), "servlet is starting"),
                    new MBeanNotificationInfo(new String[] { "j2ee.state.running" }, Notification.class.getName(), "servlet is running"),
                    new MBeanNotificationInfo(new String[] { "j2ee.state.stopped" }, Notification.class.getName(), "servlet start to stopped"),
                    new MBeanNotificationInfo(new String[] { "j2ee.object.stopped" }, Notification.class.getName(), "servlet is stopped"),
                    new MBeanNotificationInfo(new String[] { "j2ee.object.deleted" }, Notification.class.getName(), "servlet is deleted") };
