...
final class StandardContextValve extends ValveBase {
    ...
    public final void invoke(Request request, Response response) throws IOException, ServletException {
        ...
        if ((instances != null) && (instances.length > 0)) {
            event = new ServletRequestEvent(((StandardContext) container).getServletContext(), request.getRequest());
            ...
            for (int i = 0; i < instances.length; i++) {
                ...
                try {
                    ...
                    container.getLogger().error(sm.getString("standardContext.requestListener.requestInit", instances[i].getClass().getName()), t);
        ...
        if ((instances != null) && (instances.length > 0)) {
            ...
            for (int i = 0; i < instances.length; i++) {
                ...
                try {
                    ...
                    container.getLogger().error(sm.getString("standardContext.requestListener.requestDestroy", instances[i].getClass().getName()), t);
                    ServletRequest sreq = request.getRequest();
                    sreq.setAttribute(Globals.EXCEPTION_ATTR, t);
                }
            }
