...
public final class ExtensionValidator {
    ...
    private static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(ExtensionValidator.class);
     ...
     * 
     * This method uses JNDI to look up the resources located under a <code>DirContext</code>. It locates Web Application MANIFEST.MF
     * file in the /META-INF/ directory of the application and all
     * MANIFEST.MF files in each JAR file located in the WEB-INF/lib
     * directory and creates an <code>ArrayList</code> of <code>ManifestResorce<code> objects. These objects are then passed 
    ...
    /**
     * Validates a <code>ArrayList</code> of <code>ManifestResource</code> objects. This method requires an application name (which is the
     ...
     *            error messages
     * @param resources
     *            A list of <code>ManifestResource</code> objects
     *            to be validated.
     * 
    ...
    private static boolean validateManifestResources(String appName, ArrayList resources) {
        ...
        while (it.hasNext()) {
            ...
            // load the container level resource map if it has not been built yet
