...
/**
 * <p>
 * Utility class for building class loaders for Catalina. The factory method requires the following parameters in order to build a new class loader (with
 * suitable defaults in all cases):
 * </p>
 * <ul>
 * <li>A set of directories containing unpacked classes (and resources) that should be included in the class loader's repositories.</li>
 * <li>A set of directories containing classes and resources in JAR files. Each readable JAR file discovered in these directories will be added to the class
...
public final class ClassLoaderFactory {
     ...
     *            be added to the repositories of the class loader, or <code>null</code> for no unpacked directories to be considered
     * @param packed
     ...
     * @param parent
     *            Parent class loader for the new class loader, or <code>null</code> for the system class loader.
     * 
     * @exception Exception
