 ...
 * <p>
 * A given JVM can contain any number of Service instances; however, they are completely independent of each other and share only the basic JVM facilities and
 * classes on the system class path.
 * 
