...
public interface Realm {
     ...
     * security role, within the context of this Realm; otherwise return <code>false</code>.
     * 
     * @param principal
     ...
     * was not violated and processing should continue, or <code>false</code> if we have created a response already.
     * 
     * @param request
     *            Request we are processing
     * @param response
